...
public class Pahpat {
    ...
    public interface Receiver {
        void onReceiveResult(int serviceId, int resultCode, Bundle resultData) throws PahpatException, RemoteException, CertificateException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException, IOException;
    }
    ...
    public static class PahpatResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int resultCode, Bundle resultData) {
            if (mReceiver != null) {
                ...
                } catch (IOException | PahpatException | RemoteException | CertificateException | UnrecoverableKeyException | NoSuchAlgorithmException | KeyStoreException | KeyManagementException ex) {
            ...
            try {
                ...
                if (cpCursor != null) {
                    if (cpCursor.moveToFirst()) {
                        ...
                        Util.saveMerchantInfo(merchantInfoResult);
                    }
                }
            } catch (Exception e) {
    ...
    public static void voucherTxn(@NonNull Activity activity, @NonNull Handler receiverHandler, @NonNull String amount, @NonNull String productCode,
        ...
        resultReceiver.setServiceId(Pahpat.VOUCHER);
        ...
        paymentIntent.putExtra("ResultReceiver", Pahpat.receiverForSending(resultReceiver));

        activity.startActivityForResult(paymentIntent, Pahpat.VOUCHER);
    }
    ...
    public static void confirmTxn(@NonNull Activity activity, @NonNull Handler receiverHandler, @NonNull String approvalCode, @NonNull boolean decideType) throws PahpatException {
        ...
        PahpatResultReceiver resultReceiver = new PahpatResultReceiver(receiverHandler);
        resultReceiver.setServiceId(Pahpat.GOOD_CONFIRM);
        resultReceiver.setReceiver((Receiver) activity);
        ...
        confirmIntent.putExtra("ResultReceiver", Pahpat.receiverForSending(resultReceiver));
        activity.startActivityForResult(confirmIntent, Pahpat.GOOD_CONFIRM);
    }
    ...
    public static void billTxn(@NonNull Activity activity, @NonNull Handler receiverHandler, @NonNull String billId, @NonNull String billPayId,
        ...
        PahpatResultReceiver resultReceiver = new PahpatResultReceiver(receiverHandler);
        resultReceiver.setServiceId(Pahpat.BILL_PAY);
        resultReceiver.setReceiver((Receiver) activity);
        ...
        activity.startActivityForResult(paymentIntent, Pahpat.BILL_PAY);
    ...
    public static void purchaseTxn(@NonNull Activity activity, @NonNull Handler receiverHandler, @NonNull String amount, @NonNull String merchantMobileNo,
        ...
        PahpatResultReceiver resultReceiver = new PahpatResultReceiver(receiverHandler);
        resultReceiver.setServiceId(Pahpat.GOOD_PAYMENT);
        resultReceiver.setReceiver((Receiver) activity);
        if (!amount.equals("")) {
            ...
            paymentIntent.putExtra("Lang", lang);
            paymentIntent.putExtra("ResultReceiver", Pahpat.receiverForSending(resultReceiver));
            activity.startActivityForResult(paymentIntent, Pahpat.GOOD_PAYMENT);
        }
    }
}
